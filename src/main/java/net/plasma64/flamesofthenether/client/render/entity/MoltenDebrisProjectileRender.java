...
import net.plasma64.flamesofthenether.server.entity.item.MoltenDebrisProjectileEntity;


public class MoltenDebrisProjectileRender extends EntityRenderer<MoltenDebrisProjectileEntity> {
    ...
    @Override
    public void render(MoltenDebrisProjectileEntity pEntity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
        ...
        renderBlock(this.blockRenderer, FOTNBlockRegistry.MOLTEN_DEBRIS.get().defaultBlockState(), pPoseStack, pBuffer, pPackedLight);
        pPoseStack.popPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(MoltenDebrisProjectileEntity pEntity) {
